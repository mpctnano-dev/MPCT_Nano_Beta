...
$categories = [
    ...
    'booking' => [
        ...
        'fields' => [
            'equipment_id', 'equipment_name', 'equipment_category', 'equipment_status',
            'first_name', 'last_name', 'email', 'phone', 'organization', 'user_type', 'user_id',
            'preferred_date', 'preferred_time', 'estimated_duration', 'alternative_date',
            'sample_description', 'purpose_of_use', 'operating_modes',
            'sample_type', 'sample_dimensions', 'sample_conductivity', 'vacuum_compatible',
            'dut_description', 'temperature_requirements', 'atmosphere_requirements',
            'material_type', 'material_dimensions', 'consumables_needed',
            'specimen_material', 'specimen_dimensions', 'target_thickness', 'processing_type', 'cryogenic_cooling',
            'quantity_needed', 'container_type',
            'training_needed', 'lab_assistance', 'accessories', 'special_requirements',
        ],
        'labels' => [
            'equipment_id'           => 'Equipment ID',
            'equipment_name'         => 'Equipment',
            'equipment_category'     => 'Category',
            'equipment_status'       => 'Availability at Time of Request',
            ...
            'user_type'              => 'User Type',
            'user_id'                => 'NAU EMPLID / Org Detail',
            'preferred_date'         => 'Preferred Date',
            'preferred_time'         => 'Preferred Time',
            'estimated_duration'     => 'Estimated Duration',
            'alternative_date'       => 'Alternative Date',
            'sample_description'     => 'Sample / Specimen Description',
            'purpose_of_use'         => 'Purpose of Use',
            'operating_modes'        => 'Operating Modes Requested',
            'sample_type'            => 'Sample Type',
            'sample_dimensions'      => 'Sample Dimensions',
            'sample_conductivity'    => 'Sample Conductivity',
            'vacuum_compatible'      => 'Vacuum Compatible',
            'dut_description'        => 'DUT / Device Description',
            'temperature_requirements' => 'Temperature Requirements',
            'atmosphere_requirements' => 'Atmosphere Requirements',
            ...
            'cryogenic_cooling'      => 'Cryogenic Cooling Needed',
            'quantity_needed'        => 'Quantity Needed',
            'container_type'         => 'Container Type',
            'training_needed'        => 'Training Needed',
            'lab_assistance'         => 'Lab Assistance',
            'accessories'            => 'Accessories Requested',
            'special_requirements'   => 'Special Requirements',
        ],
    ],

    'educational' => [
        'title' => 'Educational Equipment — Course Request',
        'fields' => [
            'equipment_id', 'equipment_name', 'equipment_category',
            'first_name', 'last_name', 'email', 'phone', 'organization', 'user_type', 'user_id',
            'preferred_date', 'preferred_time', 'estimated_duration', 'alternative_date',
            'course_number', 'course_name', 'instructor_name', 'instructor_email',
            'group_size', 'semester', 'class_use',
            'sessions_needed', 'session_duration', 'edu_notes',
        ],
        'labels' => [
            'equipment_id'       => 'Equipment ID',
            'equipment_name'     => 'Equipment',
